...
public class GameManager : MonoBehaviour
{
    ...
    public int Sweep()
    {
        ...
        for (int h = 0; h < puzzle.height; h++)
        {
            for (int w = 0; w < puzzle.width; w++)
            {
                piece currentPiece = puzzle.pieces[w, h];

                if (currentPiece != null)
                {
                    // Compare top
                    if (h != puzzle.height - 1 && puzzle.pieces[w, h + 1] != null)
                    {
                        if (currentPiece.values[0] == 1 && puzzle.pieces[w, h + 1].values[2] == 1)
                        {
                            value++;
                        }
                    }
                    ...
                    // Compare right
                    if (w != puzzle.width - 1 && puzzle.pieces[w + 1, h] != null)
                    {
                        if (currentPiece.values[1] == 1 && puzzle.pieces[w + 1, h].values[3] == 1)
                        {
                            value++;
                        }
                    }
    ...
    public int QuickSweep(int w, int h)
    {
        ...
        if (w >= 0 && h >= 0 && w < puzzle.width && h < puzzle.height)
        {
            // Compare top
            if (h != puzzle.height - 1 && puzzle.pieces[w, h] != null && puzzle.pieces[w, h + 1] != null)
            {
            ...
            // Compare right
            if (w != puzzle.width - 1 && puzzle.pieces[w, h] != null && puzzle.pieces[w + 1, h] != null)
            {
            ...
            // Compare left
            if (w != 0 && puzzle.pieces[w, h] != null && puzzle.pieces[w - 1, h] != null)
            {
            ...
            // Compare bottom
            if (h != 0 && puzzle.pieces[w, h] != null && puzzle.pieces[w, h - 1] != null)
            {
